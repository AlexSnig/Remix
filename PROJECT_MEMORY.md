...
- Primary app purpose: mobile museum exhibit motion sensor with camera detection, audio playback, kiosk gate, stealth overlay, and local event logs.
...
- Target browser is Android Chrome on a fixed phone/tablet in a museum or exhibit setting.
...
- Add a production deployment note once the hosting target is known.
