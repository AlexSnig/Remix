...
export const TRANSLATIONS: Record<Language, TranslationSet> = {
  uk: {
    ...
    exhibitRecommendationDesc: "Закріпіть пристрій (наприклад, Galaxy A07) нерухомо навпроти експонату. За допомогою окремих кнопок камери виберіть найкращий ракурс. Завантажте голосовий опис або музичну доріжку до розділу аудіосигналів, призначте її головною, встановіть час затримки (паузу) після відтворення, увімкніть датчик та натисніть «Маскування» для імітації вимкненого екрана. Датчик працюватиме стабільно!",
  ...
  en: {
    ...
    exhibitRecommendationDesc: "Affix the smartphone (like Galaxy A07) steady facing the exhibit. Use separate camera buttons to lock the best viewpoint. Upload a voice clip narrating the history of your exhibit, toggle it active, configure custom cooldown delay, start the sensor, and click 'Stealth Masking' to turn screen of. It's safe, robust and lightweight!",
